package com.cumulocity.opcua.platform.controller.configuration;
...
//            addSerializer(ManagedObjectRepresentation.class, new JsonSerializer<ManagedObjectRepresentation>() {
//                final JSON marshaller = JSONBase.getJSONGenerator();
//
//                @Override
//                public void serialize(ManagedObjectRepresentation managedObjectRepresentation, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
//                    jsonGenerator.writeString(marshaller.forValue(managedObjectRepresentation));
//                }
//            });
        }};
    }
